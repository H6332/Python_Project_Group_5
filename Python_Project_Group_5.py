...
def print_board(matrix, rows, cols, mine_count, start_time):
    print("\n   ", end="")
    for c in range(cols):
        print(f"{c + 1:^3}", end="")
    print()
    ...
    while True:  # 整個遊戲
        ...
        while True:
            ...
            # 修改重點：執行挖掘 (D) 模式
                ...
                if first_click:
                    place_mines(matrix, rows, cols, mine_count, r, c)  # 第一次點擊保護
                    first_click = False
